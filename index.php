    ...
    <div class="row"> 
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Contact Service</a></h5>
                                <p>We provide a seamless connectivity between student and owner of property...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We include rental services too...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We do all the listing process for you to reduce your efforts and save your time...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-diagram text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Legal Process</a></h5>
                                <p>We do every legal documentation according to the need of customer...</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Recent Hostel</h2>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Seameless connectivity and peer to peer connection results in easy accomodation... </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>We do all the neccesary documentation...</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Ready to move to your new residence...</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="full-row overlay-secondary" style="background-image: url('images/breadcromb.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="fact-counter">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="count wow text-center  mb-sm-80" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
								<?php
						...
						<div class="col-md-4">
                            <div class="count wow text-center  mb-sm-80" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Rent Hostel Available</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="count wow text-center  mb-sm-80" data-wow-duration="300ms"> <i class="flaticon-man flat-large text-white" aria-hidden="true"></i>
                                <?php
