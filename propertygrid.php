                ...
                <div class="row">
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							if(isset($_REQUEST['filter']))
							{
								...
								$sql="SELECT property.*, user.uname FROM `property`,`user` WHERE property.uid=user.uid and type='{$type}' and stype='{$stype}'";
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Deposit Calculator</h4>
