            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="bg-success d-table px-3 py-2 rounded text-white text-capitalize"><a href="booking.php">For <?php echo $row['5'];?></a></div>
                        ...
                        <div class="property-details">
                            ...
                            <p><a href="booking.php"><?php echo $row['2'];?></a></p>
